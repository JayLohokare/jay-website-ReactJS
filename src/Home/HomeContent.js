                  ...
                  <div className="card white" >
                    <div className="white card-content light-blue-text text-darken-3">
                      ...
                      <p className="black-text">
                          ...
                          <br></br>
                          I have won over 15 hackathons, I have numerous research publications from top IEEE/ACM conferences, and I am actively involved in startup communities (Co-Founded three startups). At Stony Brook University, I am a part of Professor Fan Ye's research group at the ECE MOCA lab and Professor Fusheng Wang's research group at the Biomedical Big data analytics lab.
                      </p>
                      <br/>
                    </div>
                  </div>
                  ...
                  <div className="card white blue-grey text-darken-3" >
                    <div className="white card-content light-blue-text text-darken-3">
                      ...
                      <div className="container center">
                        <div className="row">
                          <div className="col s2 m2 l2"><a href="https://www.linkedin.com/in/jaylohokare" className=" tooltipped btn-floating blue white-text" data-position="bottom" data-tooltip="Linkedin"><i className="zmdi zmdi-linkedin-box"></i></a> 
                          </div>

                          <div className="col s2 m2 l2"><a href= "https://github.com/JayLohokare" className=" tooltipped btn-floating grey darken-3 white-text" data-position="bottom" data-tooltip="Github"><i className="zmdi zmdi-github"></i></a>
                          </div>

                          <div className="col s2 m2 l2"><a href= "https://www.facebook.com/jaylohokare251095" className=" tooltipped btn-floating blue darken-2 white-text" data-position="bottom" data-tooltip="Facebook"><i className="zmdi zmdi-facebook"></i></a>
                          </div>

                          <div className="col s2 m2 l2"><a href="mailto:jaylohokare@gmail.com" className="  tooltipped btn-floating red white-text" data-position="bottom" data-tooltip="Email"><i className="zmdi zmdi-email"></i></a> 
                          </div>

                          <div className="col s2 m2 l2"><a href= "https://www.instagram.com/jaylohokare" className=" tooltipped btn-floating pink  lighten-1 white-text" data-position="bottom" data-tooltip="Instagram"><i className="zmdi zmdi-instagram"></i></a> 
                          </div>

                          <div className="col s2 m2 l2"><a href="https://www.slideshare.net/jaylohokare7/" className="  tooltipped btn-floating blue white-text" data-position="bottom" data-tooltip="Slideshare"><i className="zmdi zmdi-slideshare"></i></a>
                          </div>
                        </div>
                      </div>
                    </div>
